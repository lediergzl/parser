-- Registro atómico de una apuesta recibida por WhatsApp.
-- Bloquea el cliente, calcula crédito/saldo, actualiza el saldo e inserta la apuesta
-- dentro de una única transacción PostgreSQL. Si el INSERT falla, el descuento
-- también se revierte.
