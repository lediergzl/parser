...
// Resto de acciones (mis_jugadas, editar, eliminar, depósitos, etc.) se mantienen igual que en la versión anterior.
// Por brevedad, incluyo solo los que están directamente relacionados con el problema de "Volver".
// Si quieres que te entregue el archivo completo con todos los callbacks (mis_jugadas, admin, etc.) confirmado, dime y lo adjunto.
